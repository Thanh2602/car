...
def telemetry(sid, data):
    if data:
        ...
        try:
            ...
            image, combined = pipeline.pipeline_image(image)
           
            cv2.imshow("1", image)
            cv2.imshow("2", combined)
            ...
            # remote vehicle
            """
                - dựa vào lý thuyết điều khiển tự động 
                - điều khiển tốc độ xe theo góc lái trả về 
                - góc lái từ -25 -> 25
                - tốc độ -150 -> 150
                - cách điều khiển được ban tổ chứ cung cấp :
            ...
            send_control(sendBack_angle, sendBack_Speed * 1.5)
